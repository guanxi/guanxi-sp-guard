...
Introduction
------------
The Guanxi Service Provider Guard module is the main way to
add Shibboleth and SAML2 SSO to a Java web application
...
git clone http://github.com/guanxi/guanxi-sp-guard.git
cd guanxi-sp-guard
mvn clean install
